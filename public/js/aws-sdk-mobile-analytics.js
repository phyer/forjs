...
//        console.log(this.options.apiVersion);
//        console.log(this.options.provider); 
        this.outputs.MobileAnalytics = new AWS.MobileAnalytics({ apiVersion: this.options.apiVersion,provider: this.options.provider });
